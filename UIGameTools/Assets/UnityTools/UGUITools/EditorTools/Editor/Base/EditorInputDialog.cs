...
namespace KakuEditorTools
{
    public class EditorInputDialog : EditorWindow
    {
        ...
        /// <returns></returns>
        public static string Show(string title = "输入框弹窗", string description = "请输入内容", string inputText = "", string okButton = "OK", string cancelButton = "Cancel")
        {
            string ret = "";
            ...
            // ShowModal 函数会中断Unity的其他操作，直到窗口被关闭。
            window.ShowModal();

...
namespace KakuEditorTools
{
    ...
    internal class ChineseText : StringText
    {
        public ChineseText()
        {
            ...
            H_Group = "添加水平布局器";
            Flip_layout = "反转选中布局器";
            Content_Size = "添加 Content Size";
            Layout_Element = "添加 Layout Element";
            Add_Image = "添加 Image";
            Add_Button = "添加 Button";
            Duplicate = "复制选中物体";
            V_Align = "同步到最后选择物体的X轴坐标";
            H_Align = "同步到最后选择物体的Y轴坐标";
            V_Spacing = "Y轴居中布局";
            H_Spacing = "X轴居中布局";
            TXT2TMP = "TXT -> TMP";
            RemoveRaycast = "移除UI的Raycast";
            RoundRectPos = "取整Rect的位置和宽高";
            ApplyPrefab = "保存当前预设体";
            FixCopyGoName = "修复复制体的名字";
            TrimGoName = "去除名字的前后空格";
            ExpandRect = "设置成为全依赖父物体矩形";
        }
    }
}

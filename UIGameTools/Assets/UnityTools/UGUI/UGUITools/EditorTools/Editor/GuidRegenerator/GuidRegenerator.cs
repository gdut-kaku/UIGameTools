...
// https://gist.github.com/ZimM-LostPolygon/7e2f8a3e5a1be183ac19#file-unityguidregenerator-cs
using System;
...
namespace KakuEditorTools
{
    ...
    {
        public static void RegenerateGuids(string assetPath)
        {
    ...
    internal class UnityGuidRegenerator
    {
        ...
        public void RegenerateGuids(string[] regeneratedExtensions = null)
        {
            ...
            {
                filesPaths.AddRange(Directory.GetFiles(_assetsPath, extension, SearchOption.AllDirectories));
            }
